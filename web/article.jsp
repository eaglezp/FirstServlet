...
<%!
  public void tree(List<Article> articleList, Connection conn, int id, int level){
    ...
    try {
      ...
      while(resultSet.next()){
          ...
          if (article.isLeaf() != true) {
            tree(articleList, conn, article.getId(),level + 1);
          }
      }
          ...
          <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr class="jive-even">
              ...
              <td nowrap="nowrap" width="1%">&nbsp;
                &nbsp;</td>
              <td class="jive-thread-name" width="95%"><a id="jive-thread-1" href="article_detail.jsp?id=<%=article.getId()%>"><%= string+article.getTitle()%></a></td>
              <td class="jive-author" nowrap="nowrap" width="1%"><span class=""> <a href="http://bbs.chinajavaworld.com/profile.jspa?userID=226030">eagle</a> </span></td>
