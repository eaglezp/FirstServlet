...
<div id="jive-flatpage">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr valign="top">
            <td width="99%"><p class="jive-breadcrumbs"><a
                    href="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()%>/article_flat.jsp">首页</a>
    ...
    <div class="jive-buttons">
        <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
            <tbody>
            <tr>
                <td class="jive-icon"><a href="reply.jsp?id=<%=id%>&rootId=<%=rootId%>&title=<%=title%>"><img
                        src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a></td>
                <td class="jive-icon-label"><a id="jive-reply-thread"
                                               href="reply.jsp?id=<%=id%>&rootId=<%=rootId%>&title=<%=title%>">回复本主题</a>
                </td>
            </tr>
            </tbody>
        </table>
                                        ...
                                        <td class="jive-last" width="99%">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr valign="top">
                                                    <td width="1%"></td>
                                                    <td width="97%"><span
                                                            class="jive-subject"><%=floor%>:<%=article.getTitle()%></span>
                                                    </td>
                            ...
                            <tr>
                                ...
                                <td align="center" width="98%">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()%>/article_flat.jsp"><img
                                                        src="images/arrow-left-16x16.gif" alt="返回到主题列表" border="0"
                                                        height="16" hspace="6" width="16"></a></td>
                                            <td>
                                                <a href="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()%>/article_flat.jsp">返回到主题列表</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
